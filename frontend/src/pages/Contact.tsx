export default function Contact() {
    return (
        <div className="max-w-[1100px] h-fit !mx-auto !pt-[50px] !pb-[100px] sm:!py-[100px] flex flex-col sm:flex-row justify-between items-center gap-[30px] sm:gap-[50px] md:gap-[10%]">
